...
const BankerSettings: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFeedback({ type: 'success', message: 'Banker profile updated successfully!' })
    } catch (err: any) {
  ...
  return (
    <AppLayout>
      <PageHeader title={t('nav.settings')} subtitle="Manage banker profile & workspace preferences" />

      <Card className="max-w-2xl">
        <h2 className="text-lg font-semibold text-text-primary mb-6">Banker Officer Profile</h2>
