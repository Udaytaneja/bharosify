  ...
  return (
    <AppLayout>
      <PageHeader
        ...
        subtitle="Banker alerts, loan application submissions, and risk warnings"
      />
      ...
      {notifications?.items && notifications.items.length > 0 ? (
        ...
        <EmptyState
          title="No Banker Notifications"
          description="There are no active alerts requiring banker attention."
        />
      )}
    </AppLayout>
  )
